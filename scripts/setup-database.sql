...
('home', 'hero', 'description', '🇺🇦 A loving community in Portland where Ukrainian children find hope and healing'),
...
('home', 'community_about', 'paragraph_1', 'Bozhiymir Church is more than a place of worship—we''re a diverse, loving family that spans cultures, languages, and backgrounds. Our community has grown stronger through welcoming Ukrainian families and children who have found refuge in Portland.'),
